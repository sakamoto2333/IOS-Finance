...
class ClassModel: NSObject {
    ...
    func saveData() {
        ...
        archiver.encode(ClassList, forKey: "ClassList")
        //编码结束
    ...
    func loadData() {
        ...
        if defaultManager.fileExists(atPath: path) {
            ...
            ClassList = unarchiver.decodeObject(forKey: "ClassList") as! Array
            //结束解码
    ...
    func dataFilePath ()->String{
        let 地址 = self.documentsDirectory().appending("ClassList.plist")
        return 地址
    }
}
